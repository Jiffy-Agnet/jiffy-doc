...
For a deeper look at any one piece, see [Edge Component](/docs/ecosystem/edge-component), [Gateway](/docs/ecosystem/gateway), [Agent](/docs/ecosystem/agent), and [Sandbox](/docs/ecosystem/sandbox).
